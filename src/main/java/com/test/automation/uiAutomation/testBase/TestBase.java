...
public class TestBase {
	...
	public void getUrl(String url) throws AWTException {
	...
	public void scrollBy(String leftright,String updown) {
		JavascriptExecutor oJse = (JavascriptExecutor) driver;
		oJse.executeScript("window.scrollBy("+leftright+","+updown+")", " ");
		
	}

	//@Parameters("browser")
	//@BeforeTest
	public void launchapp(String browser) throws IOException, AWTException {
		...
		if (System.getProperty("os.name").contains("Mac")) {
			if (browser.equals("chrome")) {
				...
				dr = new RemoteWebDriver(new URL(Node), cap);
